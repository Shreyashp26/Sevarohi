...
<div style="padding-bottom: 4%; padding-top: 3%;">
  ...
  <div class="row"> 
    ...
    <!-- COLUMN 2-->
   <div class="col"> 
      <img class="w3-image" src="loginbg.png" style="box-shadow: 10px 10px 5px grey"
  ...
  <form class="modal-content animate" action="userSignupAction.php" method="post">
   ...
   <!-- Form title: sign up -->
    ...
    <div class="container"> 
      ...
      <input type="text" placeholder="Enter email." id="signupMob" name="mobile" required>
