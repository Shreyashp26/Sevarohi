...
<header class="w3-container w3-theme" id="myHeader">
    ...
    <li style="float: right; margin-right: 10px;">
        <!-- Increase font size -->
        <label name="mobile" style="color:white; font-size: larger;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your mobile number: <?php echo $_SESSION['dmobile']; ?>
</label>
	...
	<h5 style="color:blue">On call Confirmation (Patient's Contact No.): </h5>
	  ...
	  <form action="sendWhatsAppMessage.php" method="post">
            <div class="container">
				...
				<br>
				<button type="submit" name="track"><b>Whatsapp Patient</b></button>
			</div>
        </form>
      </div><!-- COLUMN 2-->
    </div> <!-- ROW -->
